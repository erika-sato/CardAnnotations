...
module.exports = {
   ...
   async read(request, response) {
     ...
     async create(request, response) {   //fç que cria registro no banco de dados
        const {title, notes, priority} = request.body  //do corpo da requisição, vou extrair essas 3 informações
